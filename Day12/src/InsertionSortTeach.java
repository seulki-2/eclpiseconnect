...
public class InsertionSortTeach {
private int comparisonCnt;  //비교 횟수

public InsertionSortTeach() {
    comparisonCnt = 0;
}
public static void main(String[] args) {
	InsertionSortTeach InsertionSortTech = new InsertionSortTeach();
    int data [] = new int[50];
    ...
    InsertionSortTech.InsertionSortTech(data);

    for(int i : data) {
        System.out.print(i +", ");
    }
    System.out.println();
    System.out.println("비교 횟수: "+InsertionSortTech.comparisonCnt);
}
public void InsertionSortTech(int[] data) {
